"""Acceptance tests for dudamel/widgets.py::run_widget (Plan 3 Task 1)."""

from dudamel.contract.types import Widget
from dudamel.widgets import run_widget


def make_widget(fn, *, renderer: str = "stat", id: str = "w1", title: str = "W") -> Widget:
    return Widget(id=id, app_name="app", title=title, renderer=renderer, fn=fn)
